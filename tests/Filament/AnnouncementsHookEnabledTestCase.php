 ...
 * integration enabled (the package defaults) against a control plane, so the
 * registered render-hook closure has one active announcement to render.
 *
 * Not final: Pest dynamically subclasses the bound test case (see the
 * tests/TestCase.php precedent and pint.json `notPath`).
 */
class AnnouncementsHookEnabledTestCase extends Orchestra
{
    /**
